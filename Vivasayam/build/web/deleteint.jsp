...
<html>
    ...
    <body>
        <%String phn=request.getParameter("s");
            %>
        <div>
    ...
    <center>
        ...
        <form action="http://localhost:8084/Vivasayam/deleteprof.jsp" method="GET">
            <h1>Search for intermediator profile:</h1>  <input type="text" name="s" id="s" placeholder="search by phone number of user"/>
            <input type="submit" value="Delete account"/>
            <h3 style="color:red">Account Deleted</h3>
        </form>
        ...
        <%
            ...
            try{
                        ...
                        st.executeUpdate("delete from vivasayam where phone='"+phn+"' ");
                        PreparedStatement ps=con.prepareStatement("select * from vivasayam where choice=? ");
                        ps.setString(1, "intermedia");
