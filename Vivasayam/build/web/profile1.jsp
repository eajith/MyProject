...
<html>
    ...
    <body>
        ...
        <div>
         ...
         <h1>User Profile :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a href="updateProfile1.jsp"><input type="submit" value="update profile"/></a><a href="del.jsp"><input type="submit" value="delete account" class="aa"/> </a>     </h1>      
