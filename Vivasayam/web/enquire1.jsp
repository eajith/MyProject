...
<html>
    ...
    <center>
        <form action="http://localhost:8084/Vivasayam/enquire1.jsp" method="GET">
             <h1>Search By market:</h1><input type="text" name="s" id="s" placeholder="search"/>
        ...
        <%
            ...
            try{
                        ...
                        PreparedStatement ps=con.prepareStatement("select * from veg where market=?");
                        ps.setString(1, veg);
